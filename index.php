...
<?php include("class_lib.php"); ?>
            ...
            <div id="content" class="clearfix">
                <aside>
                        ...
                        <?php
                           $spec = new Menuitem("The WP Burger","26/10/17","Freshly made all-beef patty served up with homefries","$14.00");
                           echo "<h3>" . $spec->get_menuitem() . "</h3>";
						   echo "<p>" .$spec->get_idat() . "</p>";
                           echo "<p>" . $spec->get_desc() . " - " . $spec->get_price() . "</p>";
                        ?>
                        <hr>
                        <img src="images/kebobs.jpg" alt="Kebobs" title="WP Kebobs">
                        <?php
                           $spec2 = new Menuitem("WP Kebobs","26/4/17","Tender cuts of beef and chicken, served with your choice of side","$17.00");
                ...
                <div class="main">
                    ...
                    <p>
                    <?php
					   $mi = new Menuitem("Soup & Sandwich","26/5/10","Homemade soup made daily.","$9.99");
